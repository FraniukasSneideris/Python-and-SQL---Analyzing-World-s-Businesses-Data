...
This graphic is particullary interesting because we can see in which continents the first businesses appeared. This graphic makes perfect sense with the historic data we have, being that Asia and Europe were the first places to develop, and Africa the last to join the party. 
